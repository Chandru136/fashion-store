-- CreateEnum
CREATE TYPE "RoleEnum" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'PRODUCT_MANAGER', 'INVENTORY_MANAGER', 'ORDER_MANAGER', 'CONTENT_MANAGER', 'CUSTOMER');
...
CREATE TABLE "Coupon" (
    ...
    "minimumOrderAmount" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
...
CREATE TABLE "Banner" (
    ...
    "mobileImage" TEXT,
    "buttonText" TEXT DEFAULT 'Shop Collection',
    "buttonUrl" TEXT DEFAULT '/products',
...
CREATE TABLE "Collection" (
    ...
    "image" TEXT NOT NULL,
    "mobileImage" TEXT,
    "buttonText" TEXT DEFAULT 'Explore Now',
    "status" TEXT NOT NULL DEFAULT 'ACTIVE',
    "displayOrder" INTEGER NOT NULL DEFAULT 0,
